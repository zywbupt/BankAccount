...
/**  
* @ClassName: NoticeWith  
* @Description: TODO
* @author zhan_even  
* @date 2019年5月10日  
*    
*/
public class NoticeWith implements KeyListener, ActionListener {
	 ...
	 * @param accno
	 */
	public NoticeWith(Bank b, int accno) {
		bank = b;
	...
	*/
	...
	public void actionPerformed(ActionEvent e) {
		...
		int num = bankAccount.noticeWithdraw(amount);
		if (num == 1) {
			...
			JOptionPane.showMessageDialog(new JFrame().getContentPane(),
					"You have already had a noticeWithdraw!", "System Message",
					JOptionPane.INFORMATION_MESSAGE);
		}
		else if (num == 3) {
			JOptionPane.showMessageDialog(new JFrame().getContentPane(),
			...
			JOptionPane.showMessageDialog(new JFrame().getContentPane(),
					"Not a saver Account!", "System Message",
					JOptionPane.INFORMATION_MESSAGE);
			frame.setVisible(false);
		}
		else {
			JOptionPane.showMessageDialog(new JFrame().getContentPane(),
					"Notice withdraw succssfully!" + "\n" +
					"Notice Withdraw number: " + bankAccount.getNoticeWithdraw() + "\n" +
					"Notice date:" + bankAccount.getNoticeDate(), "System Message",
					JOptionPane.INFORMATION_MESSAGE);
			frame.setVisible(false);
		}
		withAmount.setText("");
